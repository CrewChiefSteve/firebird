...
/** Jennifer's view: unpaid hours per person, mark paid through a date. */
export function Payroll() {
  ...
  return (
    <section className="panel">
      <header><h2>Payroll</h2><span className="hint">unpaid hours by person · mark paid through a date</span></header>
      <div className="bd">
        <div className="row">
          ...
          {clockers.map((c) => {
            ...
            return (
              <div className="pay" key={c.short} style={{ ["--pc" as string]: c.color }}>
                ...
                <button className="btn primary" disabled={unpaidMin === 0} onClick={async () => {
